...
- Prefer to use existing shadcn UI primitives to build composable components, matching the design system. You may use the `shadcn` skill for detailed instructions.
